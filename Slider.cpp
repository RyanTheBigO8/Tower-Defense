...
void Slider::OnMouseDown(int button, int mx, int my) {
    ...
    if( mx > ImageButton::Position.x - ImageButton::Size.x/2
       && mx < ImageButton::Position.x + ImageButton::Size.x/2
       && my > ImageButton::Position.y - ImageButton::Size.y/2
       && my < ImageButton::Position.y + ImageButton::Size.y/2 )
        Down = true;
}
...
void Slider::OnMouseMove(int mx, int my) {
    ...
    if( Down == true && mx > End1.Position.x && mx < End2.Position.x )
    {
        ImageButton::Position.x = mx;
    }
    value = (ImageButton::Position.x - End1.Position.x) / Bar.Size.x;
